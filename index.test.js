...
describe("convert()", () => {
    ...
    it("converts leap year dates with ease", () => {
        expect(convert({year: 2020, month: 11, day: 30})).toBe(-302079.23);
        expect(convert({year: 2016, month: 9, day: 24})).toBe(-306251.37);
        expect(convert({year: 2012, month: 4, day: 15})).toBe(-310666.67);
